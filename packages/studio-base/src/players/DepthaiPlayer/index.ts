...
import DepthaiClient from "@foxglove/studio-base/players/DepthaiPlayer/DepthaiClient";
...
export default class DepthaiPlayer implements Player {
  private readonly _sourceId: string;

  private _url: string; // WebSocket URL.
  private _name: string;
  private _client?: DepthaiClient; // The client when we're connected.
  ...
  private _open = (): void => {
    ...
    this._client = new DepthaiClient();
